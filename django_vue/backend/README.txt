...
django-admin startproject project_setup . 

# ---- gunicorn seeting  ------#
gunicorn project_setup.wsgi:application --bind 0.0.0.0:8000
gunicorn project_setup.wsgi:application --reload --keyfile=./cert/key.pem --certfile=./cert/cert.pem
